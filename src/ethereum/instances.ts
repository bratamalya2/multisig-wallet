...
import { TestContractFactory } from './typechain/TestContractFactory';
...
window.testContractInstance = TestContractFactory.connect('0x9753f5F7333145448DffD312aD81c751d2D6A683', window.provider);
